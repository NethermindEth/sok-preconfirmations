...
In this section, we describe how the mev-commit protocol issues preconfirmations (``preconfs''), or \emph{commitments} in the protocol's terminology. While we follow the general structure introduced in Section~\ref{}, it is important to note that sometimes mev-commit slightly departs from that framework. 
